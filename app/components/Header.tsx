      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="tel:+12252613866" className="text-primary-blue font-semibold hover:text-primary-blue-light transition-colors">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4">
            ...
            <div className="pt-4 space-y-2">
              <a href="tel:+12252613866" className="block w-full bg-primary-blue text-white px-6 py-3 rounded-lg font-semibold text-center">
                Call Now
              </a>
